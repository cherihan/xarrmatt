...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('XmUserBundle:User')->findAll();

        return $this->render('XmUserBundle:User:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('XmUserBundle:User')->find($id);
